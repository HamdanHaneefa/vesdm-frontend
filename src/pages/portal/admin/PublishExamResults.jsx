...
const PublishExamResults = () => {
  ...
  const [students, setStudents] = useState([
    { id: 1, rollNo: 'VESDM2026001', name: 'Amit Kumar', franchise: 'Delhi Branch', marks: '', status: 'pending' },
    { id: 2, rollNo: 'VESDM2026002', name: 'Priya Sharma', franchise: 'Mumbai Branch', marks: '', status: 'pending' },
    { id: 3, rollNo: 'VESDM2026003', name: 'Rahul Verma', franchise: 'Bangalore Branch', marks: '', status: 'pending' },
    { id: 4, rollNo: 'VESDM2027001', name: 'Sneha Patel', franchise: 'Delhi Branch', marks: '', status: 'pending' },
    { id: 5, rollNo: 'VESDM2026004', name: 'Vikram Singh', franchise: 'Chennai Branch', marks: '', status: 'pending' },
    { id: 6, rollNo: 'VESDM2026005', name: 'Anjali Gupta', franchise: 'Pune Branch', marks: '', status: 'pending' }
  ]);

  const exams = [
    { id: 1, name: 'Mid-Term Exam - Programming Fundamentals', subject: 'Programming', date: '2026-03-15', deadline: '2026-03-10', totalMarks: 100, passingMarks: 40 },
    { id: 2, name: 'Mid-Term Exam - Web Technologies', subject: 'Web Tech', date: '2026-03-18', deadline: '2026-03-13', totalMarks: 100, passingMarks: 40 },
    { id: 3, name: 'Final Exam - Database Management', subject: 'DBMS', date: '2026-03-20', deadline: '2026-03-15', totalMarks: 100, passingMarks: 40 }
  ];
  ...
  const handlePublish = () => {
    ...
    const updatedStudents = students.map(student => {
      ...
      return {
        ...
        certificateGenerated: isPassed // Generate certificate for passed students
      };
    });

    const passedCount = updatedStudents.filter(s => s.status === 'passed').length;

    setStudents(updatedStudents);
    alert(`✅ Results published successfully for ${selectedExamData.name}!\n\n📊 Summary:\n• Total Students: ${updatedStudents.length}\n• Passed: ${passedCount}\n• Failed: ${updatedStudents.length - passedCount}\n\n🎓 Certificates automatically generated for ${passedCount} passed student(s)!`);
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-red-100 mt-1">Enter marks and publish results for all students</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="space-y-6">
            ...
            {selectedExamData && (
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 p-6 bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl">
                <div>
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-700">{selectedExamData.deadline}</p>
                  <p className="text-xs text-emerald-600 font-semibold mt-1">✓ Closed</p>
                </div>
              </div>
            )}
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-3">
                <button className="flex items-center gap-2 px-4 py-2 border-2 border-red-200 text-red-700 rounded-xl font-semibold hover:bg-red-50 transition-colors">
                  ...
                  {students.map((student) => {
                    ...
                    return (
                      <tr key={student.id} className="hover:bg-red-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-sm text-slate-600">{student.franchise}</td>
            ...
            {/* Statistics */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8 p-6 bg-gradient-to-br from-slate-50 to-red-50 rounded-2xl">
              <div>
